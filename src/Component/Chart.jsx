  ...
  return (
    <div className=" h-screen w-fit    sm:w-fit  sm:h-screen lg:flex lg:items-center xl:flex xl:items-center bg-cyan-100 ">
      <div className="  h-screen w-[100%] m-0 pb-0 lg:h-screen xl:h-screen">
        <div className="flex bg-gray-700 shadow-lg shadow-slate-900 box-border  items-center lg:justify-center xl:justify-center">
          <img
            src={logo}
            alt="logo"
            className="w-28  mr-24 -ml-6 lg:w-24 lg:-mt-5 lg:-mb-5 lg:ml-1  xl:w-24  xl:-mt-5  xl:-mb-5  xl:ml-1"
          />
        ...
        <div className="input flex bg-gray-600">
          ...
          <input
            ...
            className="bg-gray-600 h-12 w-[90%] text-white text-xl outline-none"
          />
          ...
          >
            {!text ? (
              ...
              <IoSendSharp className="w-24 xl:w-28 lg:w-28 text-3xl text-white " />
            )}
          </button>
        </div>
      </div>
